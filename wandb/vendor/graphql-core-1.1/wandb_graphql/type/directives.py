...
class GraphQLDirective(object):
    ...
    def __init__(self, name, description=None, args=None, locations=None):
        ...
        assert isinstance(locations, collections.abc.Iterable), 'Must provide locations for directive.'
        ...
        if args:
            assert isinstance(args, collections.abc.Mapping), '{} args must be a dict with argument names as keys.'.format(name)
